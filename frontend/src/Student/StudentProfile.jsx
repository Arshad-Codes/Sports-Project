    ...
    <>
      ...
      <section>
        ...
        <div className="sm:w-[80%] xs:w-[90%] mx-auto flex">
          ...
          <h1
            className="w-full text-left my-4 sm:mx-4 xs:pl-4 text-gray-800 dark:text-white 
        ...
        <div className="xl:w-[80%] lg:w-[90%] md:w-[90%] sm:w-[92%] xs:w-[90%] mx-auto flex flex-col gap-4 items-center relative lg:-top-8 md:-top-6 sm:-top-4 xs:-top-4">
          ...
          <p className="w-fit text-gray-700 dark:text-gray-400 text-md">
            Hey there! I'm {currentUser.firstName + ' ' + currentUser.lastName},
            an avid sports enthusiast with a passion for all things athletic.
            From the thrill of scoring goals on the soccer field to the
            precision of sinking that perfect three-pointer on the basketball
            court, sports have always been my playground. Whether it's cheering
            on my favorite teams, analyzing game strategies, or hitting the gym
            for a workout session, I'm always in the zone. Let's dive into the
            world of sports together and celebrate the adrenaline, camaraderie,
            and sheer excitement that it brings!
          </p>
              ...
              <div className="w-full">
                <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                  <div className="flex flex-col pb-3">
                    <dt className="mb-1 text-xl  md:text-lg dark:text-gray-400">
                      First Name
                    </dt>
                  ...
                  <div className="flex flex-col py-3">
                    ...
                    <dd className="text-gray-500 font-semibold">
                      {Dateformat(currentUser.dateofBirth)}
                    </dd>
                  </div>
                  <div className="flex flex-col py-3">
                    <dt className="mb-1 text-xl md:text-lg dark:text-gray-400">
              ...
              <div className="w-full">
                <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white  gap-2 dark:divide-gray-700 ">
                  ...
                  <div className="flex flex-col pt-3">
                    ...
                    <dd className="text-gray-500 font-semibold">
                      {Dateformat(currentUser.createdAt)}
                    </dd>
                  </div>
                </dl>
              </div>
