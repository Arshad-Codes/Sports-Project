    ...
    <section className="relative">
      ...
      <div className="xl:w-[80%] lg:w-[90%] md:w-[90%] sm:w-[92%] xs:w-[90%] mx-auto flex flex-col gap-4 items-center relative lg:-top-8 md:-top-6 sm:-top-4 xs:-top-4">
        ...
        <p className="w-fit text-gray-700 dark:text-gray-400 text-md">
          ...
          an avid sports enthusiast with a passion for all things athletic. From
          the thrill of scoring goals on the soccer field to the precision of
          sinking that perfect three-pointer on the basketball court, sports
          have always been my playground. Whether it's cheering on my favorite
          teams, analyzing game strategies, or hitting the gym for a workout
          session, I'm always in the zone. Let's dive into the world of sports
          together and celebrate the adrenaline, camaraderie, and sheer
